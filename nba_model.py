...
def get_injury_impact(team_name, raw_text):
    ...
    # 🚨 V25.0 核心修正：設立傷兵扣分上限，最多只扣 8.5 分，避免分數崩盤
...
if games_df.empty:
    ...
    # 判斷是否為「回測過去日期」。若是，考量到今天的傷兵名單不能代表過去，我們將傷兵影響降到最低。
